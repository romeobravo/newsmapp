...
jvm.inherits(jvm.SVGCircleElement, jvm.SVGShapeElement);jvm.SVGRectElement = function(config, style){
  //console.log('rect make');
  //console.log('parent class', jvm.SVGRectElement.parentClass);
  jvm.SVGRectElement.parentClass.call(this, 'rect', config, style);
};
